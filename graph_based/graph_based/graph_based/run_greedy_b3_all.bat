call run_greedy_b3.bat 1 0
call run_greedy_b3.bat 1 1
call run_greedy_b3.bat 1 2
call run_greedy_b3.bat 1 5
call run_greedy_b3.bat 2 0
call run_greedy_b3.bat 2 1
call run_greedy_b3.bat 2 2
call run_greedy_b3.bat 2 5
...
mv user_study user_study_error_50r0_b3_extra3